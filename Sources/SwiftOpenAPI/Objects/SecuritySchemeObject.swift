...
public extension SecuritySchemeObject {
    ...
    /// Basic authentication is a simple authentication scheme built into the HTTP protocol. The client sends HTTP requests with the Authorization header that contains the word Basic word followed by a space and a base64-encoded string username:password. For example, to authorize as demo / p@55w0rd the client would send
    static func basic(description: String?) -> SecuritySchemeObject {
    ...
    static func bearer(format: String? = nil, description: String? = nil) -> SecuritySchemeObject {
        SecuritySchemeObject(
            type: .http,
    ...
    static func openIDConnect(url: String, description: String? = nil) -> SecuritySchemeObject {
        SecuritySchemeObject(
            type: .openIdConnect,
